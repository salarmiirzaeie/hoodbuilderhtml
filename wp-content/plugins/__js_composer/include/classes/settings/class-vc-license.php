...
class Vc_License {
	...
	public function finishActivationDeactivation( $activation, $user_token ) {
		...
		if ( $activation ) {
			$this->setLicenseKey( '020a2dd4-4277-425a-b450-426663f52633' );
	...
	public function checkLicenseKeyFromRemote() {
		$license_key = '020a2dd4-4277-425a-b450-426663f52633';
	...
	public function setLicenseKey( $license_key ) {
			...
			vc_settings()->set( self::$license_key_option, '020a2dd4-4277-425a-b450-426663f52633' );
	...
	public function getLicenseKey() {
		...
		return '020a2dd4-4277-425a-b450-426663f52633';
	}

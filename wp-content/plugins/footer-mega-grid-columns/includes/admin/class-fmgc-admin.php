	...
	*/
	...
	?>
		<div class="fmgc-widget-opts-wrp">
			<hr>
			<strong><?php esc_html_e('Footer Mega Grid Columns Settings', 'footer-mega-grid-columns'); ?>:</strong>
			<hr>
			...
			<p class="fmgc-pro-feature">
				<label><?php esc_html_e('Grid', 'footer-mega-grid-columns'); ?><span class="fmgc-pro-tag"><?php esc_html_e('PRO','accordion-and-accordion-slider');?></span><br/>
				<select class='widefat' name='<?php echo esc_attr($widget->get_field_name('widget_grid')); ?>' disabled="">
					<option><?php esc_html_e('Grid 1', 'footer-mega-grid-columns'); ?></option>
				</select>
				</label>
			</p>
			<p class="fmgc-pro-feature">
				<label for='<?php echo esc_attr($widget->get_field_id('widget-css-class')); ?>'><?php esc_html_e('CSS Class', 'footer-mega-grid-columns') ?><span class="fmgc-pro-tag"><?php esc_html_e('PRO','accordion-and-accordion-slider');?></span><br/>
				<input type="text" class='widefat' name='<?php echo esc_attr($widget->get_field_name('widget_css_class')); ?>' disabled="" />
				</label>
			</p>

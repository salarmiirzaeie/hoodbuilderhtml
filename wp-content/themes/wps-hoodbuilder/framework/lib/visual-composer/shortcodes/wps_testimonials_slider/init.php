...
vc_map( array(
	"base"                     => "wps_testimonials_slider",
	"name"                     => "Testimonials",
	"description"    		   => "Insidepage Slider",
	"category"                 => 'WPSailor',
	"content_element"          => true,
	"show_settings_on_create"  => false,
	"icon"                     => $wps_vc_element_icon,
	"as_parent"                => array('only' => 'wps_testimonials_slider_content'),
	"params"                   => array(
        array(
            'type'           => 'textfield',
		...
		array(
			'type'           => 'textfield',
			'heading'        => 'Testimonial Page Link',
			'param_name'     => 'testimonial_page_link',
			'admin_label'	 => true,
			'description'    => ''
		),
		array(
...
vc_map( array(
	"base"             => "wps_testimonials_slider_content",
	"name"             => "Testimonial Content",
	"description"      => "Add testimonial content",
	"category"         => 'WPSailor',
	"content_element"  => true,
	"icon"			   => $wps_vc_element_icon,
	"as_child"         => array('only' => 'wps_testimonials_slider'),
	"params"           => array(
        array(
            'type'           => 'attach_image',
            'heading'        => 'Image',
...
class WPBakeryShortCode_WPS_Testimonials_Slider extends WPBakeryShortCodesContainer {}
class WPBakeryShortCode_WPS_Testimonials_Slider_Content extends WPBakeryShortCode {}
...
vc_map( array(
	"base"                     => "wps_testimonials_slider_homepage",
	...
	"as_parent"                => array('only' => 'wps_testimonials_slider_homepage_content'),
	"params"                   => array(
        array(
            'type'           => 'textfield',
		...
		array(
			...
			'value'          => '',
			'description'    => 'Add video featured image here.'
		),
		array(
			'type'           => 'textfield',
			'heading'        => 'Video Url',
...
vc_map( array(
	"base"             => "wps_testimonials_slider_homepage_content",
	"name"             => "Testimonial Content",
	"description"      => "Add testimonial content",
	"category"         => 'WPSailor',
	"content_element"  => true,
	"icon"			   => $wps_vc_element_icon,
	"as_child"         => array('only' => 'wps_testimonials_slider_homepage'),
	"params"           => array(
        array(
            'type'           => 'attach_image',
            'heading'        => 'Image',
...
class WPBakeryShortCode_wps_testimonials_slider_homepage extends WPBakeryShortCodesContainer {}
class WPBakeryShortCode_wps_testimonials_slider_homepage_content extends WPBakeryShortCode {}